...
function run()
    ...
    for T in time_step
        ...
        v0 = DyadSum(Dyad(N,5,9))

        v0 = SparseDyadVectors(v0, R = 10)
        # display(v0)
    ...
    # title!("Expectation value of Z_1 using SCI(R = $R_1) and Eigendecomposition of L N=$N", titlefontsize = 10)
    # plot!(time_step, eig_val, label = "Eig")
